...
<div >
	...
	<div>
		...
		<select name="ordby" onchange="get_order(this);" class="common_selector2" id="ordby" style="margin-right: 15px; float:right; background-color:#ff851b ;color:white; border:1px solid grey; border-radius:5px; height:40px; width:125px;">
			<Option value="name"<?php if($mordby == "name"){echo("selected");}?>>Sort by </option>
...
$(document).ready(function(){
    ...
    function filter_data()
    {
		...
		var mfinditem2 = "fan"; // <?php echo '"'.$mfinditem.'"'?>; // "fan";
...
//		alert($("#minprice").val());
        ...
        $.ajax({
            url:"fetch_data.php",
            method:"POST",
            data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price, itm_brand:itm_brand,  slug:slug2, itm_price:itm_price, ordby:mordby, finditem:mfinditem2},
