...
(1, 'www.thesoftwareguy.in', 'How to create a simple dynamic website with php and mysql.');

CREATE TABLE IF NOT EXISTS `mp_prodgrp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `grpname` varchar(255) DEFAULT NULL,
  `grpimage` varchar(255) DEFAULT NULL,
  `grppos` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
